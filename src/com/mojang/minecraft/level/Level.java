      ...
      if(!Float.isNaN(var1.x) && !Float.isNaN(var1.y) && !Float.isNaN(var1.z)) {
         if(!Float.isNaN(var2.x) && !Float.isNaN(var2.y) && !Float.isNaN(var2.z)) {
            ...
            while(var9-- >= 0) {
               ...
               a var21 = a.b[var22];
               if(var22 > 0 && var21.d() == LiquidType.NOT_LIQUID) {
                  Vector3DCreator var23;
                  if(var21.a()) {
      ...
      for(int var12 = var6; var12 < var7; ++var12) {
         for(var13 = var9 - 1; var13 >= var8; --var13) {
            for(int var14 = var10; var14 < var11; ++var14) {
               ...
               int var19;
               if(var12 >= 0 && var13 >= 0 && var14 >= 0 && var12 < this.width && var13 < this.depth && var14 < this.height && var15 * var15 + var16 * var16 + var17 * var17 < var5 * var5 && (var19 = this.getTile(var12, var13, var14)) > 0 && a.b[var19].g()) {
                  a.b[var19].a(this, 0.3F);
